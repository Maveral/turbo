...
class MechanicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mechanic" do
    assert_difference('Mechanic.count') do
      post mechanics_url, params: { mechanic: { age: @mechanic.age, experience: @mechanic.experience, name: @mechanic.name, surname: @mechanic.surname } }
    end
  ...
  test "should update mechanic" do
    patch mechanic_url(@mechanic), params: { mechanic: { age: @mechanic.age, experience: @mechanic.experience, name: @mechanic.name, surname: @mechanic.surname } }
